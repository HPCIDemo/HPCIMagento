...
class Hostedpci_Hpci_Model_Resource_Card_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    /**
     *
     */
    ...
    {
        $this->getSelect()
            ->where('main_table.customer_id = ?', (int)$customer->getId());
        return $this;
    }
}
